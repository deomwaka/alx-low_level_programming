...
Using dynamic libraries in C, how to create and use them with `$LD_LIBRARY_PATH`, `nm`, `ldd`, and `ldconfig`.
...
* **0. A library is not a luxury but one of the necessities of life**
  ...
  * Header file containing the prototypes of all functions included in `libholberton.so`.
